...
| Today's plan | **69+** above the normal band → **Train hard**; **31–68** inside it → **Train as planned** (the trials' prescribed session); below the band → **Go easy** or **Rest**. The band edges are the same ±0.5 SD and −1.5 SD lines read on the percentile scale, and on 553 days here they fell on 31.6%, 37.0% and 31.4% of days, against the 30.9 / 38.3 / 30.9% they are meant to cut off | ±0.5 SD decision line: Javaloyes 2019, [Kiviniemi et al., 2007](https://pubmed.ncbi.nlm.nih.gov/17849143/); 1.5 SD below "worth acting on": Thornton 2019 |
...
| Through the day | Every refresh recomputes the load ratio with today's strain so far. Before a session, the plan steps down as it climbs: past **1.3** no hard session (Train hard → Train as planned), past **1.5** Go easy. The card says how much strain is left before 1.3 ("passes 1.3 if today's strain goes over 14.2") — the day strain that puts the ratio exactly on the line, solved from the same 7- and 28-day averages. A nap changes readiness itself, because hours asleep count naps. "Today" is the current WHOOP day, from one sleep to the next | Load-ratio bands: [Gabbett, 2016](https://bjsm.bmj.com/content/50/5/273) — disputed as an injury predictor: [Impellizzeri et al., 2020](https://pubmed.ncbi.nlm.nih.gov/32502973/) |
